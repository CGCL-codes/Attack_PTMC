...
def main():
    ...
    for index, example in enumerate(eval_dataset):
        ...
        statements = filter_state(code_1, statements)
        ...
        total_cnt += 1
        if len(statements) == 1:
            _res = attacker.wir_random_attack(example, statements, code_pair)
            if _res['succ'] == True:
                attack_succ_1 += 1
                attack_succ_3 += 1
            ...
            _res_1 = attacker.wir_random_attack(example, statements_1, code_pair)
            if _res_1['succ'] == True:
                attack_succ_1 += 1
                attack_succ_3 += 1
            ...
            if flag == 0:
                ...
                _res_3 = attacker.wir_random_attack(example, statements_3, code_pair)
                if _res_3['succ'] == True:
                    attack_succ_3 += 1
