...
if __name__ == "__main__":
    ...
    for index, example in enumerate(eval_examples):
        ...
        if result["is_success"] == 1:
            success_attack += 1
            recoder.write(index, code, result['tokens'], len(orig_code_tokens), len(identifiers),
                          replace_info, attacker.query - query_times, example_end_time, "MHM")
        else:
