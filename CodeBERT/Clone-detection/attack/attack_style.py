...
def main():
    ...
    parser.add_argument("--csv_store_path1", default=None, type=str,
                        help="Base Model")
    # parser.add_argument("--csv_store_path2", default=None, type=str,
    #                     help="Base Model")
    # parser.add_argument("--csv_store_path3", default=None, type=str,
    #                     help="Base Model")
    ...
    # recoder5 = Recorder_style(args.csv_store_path3)
    # print("142")
