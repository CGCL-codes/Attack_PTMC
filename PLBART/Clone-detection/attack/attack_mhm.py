...
from utils import set_seed, PLBARTCodeDataset
import sentencepiece as spm
from utils import Recorder, get_code_tokens, build_vocab
from run import TextDataset
from attacker import get_code_pairs
from attacker import MHM_Attacker, convert_examples_to_features
...
def main():
    ...
    for index, example in enumerate(eval_dataset):
        ...
        if _res['succ'] == True:
            ...
            # new_feature = convert_examples_to_features(_res['tokens'], code_2, ground_truth, None, None, tokenizer,
            #                                            args, None)
