...
from utils import Recorder, get_code_tokens, PLBARTCodeDataset
...
def main():
    ...
    for index, example in enumerate(eval_dataset):
        ...
        if is_success == 1:
            ...
            # new_feature = convert_examples_to_features(adv_code, code_2, example[3].item(), None, None,
            #                                            tokenizer, args, None)
            #
