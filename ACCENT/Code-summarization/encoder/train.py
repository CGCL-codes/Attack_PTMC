...
def train(model, train_data, optimizer, criterion):
    ...
    for epoch in range(EPOCHES):
        ...
        if avg_loss < old_loss:
            torch.save(model.state_dict(),'../Code-summarization/encoder/model1.pkl')
            old_loss=avg_loss
...
if __name__ == '__main__':
    ...
    data=pd.read_pickle('../Code-summarization/encoder/train_data1.pkl')
    print('read embedding....')
    root = '../Code-summarization/encoder'
