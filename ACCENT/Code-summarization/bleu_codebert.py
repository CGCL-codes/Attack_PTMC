...
from word_saliency import computer_best_substitution, computer_word_saliency_cos, read_examples, return_bleu
...
if __name__ == '__main__':
    ...
    for mycnt in range(start_num, end_num):
        ...
        f_code2 = open(data_root + '/CodeBert/data/java11/test/code_adv3_rnn.original_subtoken', 'r')
